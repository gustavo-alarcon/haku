...
export class CreateUserComponent implements OnInit {
  ...
  create(): void {
    ...
    this.http.post(`https://us-central1-haku.cloudfunctions.net/msCreateUser/?email=${this.userForm.value['email']}&displayName=${this.userForm.value['name'].split(" ", 1)[0] + ', ' + this.userForm.value['lastname'].split(" ", 1)[0]}&password=${this.userForm.value['pass']}`
      , this.data
      , this.httpOptions)
      .pipe(
        take(1)
